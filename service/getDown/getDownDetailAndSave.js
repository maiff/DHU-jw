...
var downDetailModel=require('./createDownDetailModel');
...
var saveIntoDB=require('../getDetailInner/saveInformationIntoDb');

function pc_detail_and_save(){
...
function dealDetail(data){
	 detail('http://jw.dhu.edu.cn/dhu/index/'+data.link,function(pc_data){
	      	...
	      	saveIntoDB(pc_data,mongoose,downDetailModel);
	      })
}
